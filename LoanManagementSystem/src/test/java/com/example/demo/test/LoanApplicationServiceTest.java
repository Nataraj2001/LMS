...
class LoanApplicationServiceTest {
    ...
    void testAcceptLoan_Success() throws EmailSendingException {
        ...
        doNothing().when(emailService).sendLoanApprovalEmail(anyString(), anyString(), null, anyDouble());
    ...
    @Test
     void testAcceptLoan_ApprovalSuccess() throws EmailSendingException {
        ...
        doNothing().when(emailService).sendLoanApprovalEmail(anyString(), anyString(), anyString(), anyDouble());
        ...
        verify(emailService).sendLoanApprovalEmail(anyString(), anyString(), anyString(), anyDouble());
    }
